	...
	<script>
		...
		var min=$('#min').val();
			...
			if(max<min){
				...
				$('#max_err').html("Pool amount must be more than minimum pool amount");
			}
		};
		</script>
</head>
...
<div class="col-lg-6 ">
    ...
    <input type="number" placeholder="Pool Amount" name="pamount" class="validate[required] form-control" id="max" >
   <span id="max_err"></span>
	</div>
</div>
...
<div class="col-lg-6 ">
    ...
    <input type="number" placeholder="Minimum Pool Amount" onblur="check_min();" name="mamount" class="validate[required] form-control" id="min" >
