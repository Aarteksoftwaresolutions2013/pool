...
<!-- /Modal2 -->
    ...
    <header class="terms-header">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="tagline"><span>faq</span></h1>
                </div>
            </div>
        </div>
    </header>
...
<div class="col-sm-10 faqpage">
        ...
        <div class="row col-sm-8">
           ...
           <div class="row col-sm-4 faqpage helpbox">
           
           <div class="col-sm-12">
<h3>           Can't find what you're looking for?</h3>
           <p>
           Send us an email. Phone support is available by appointment only. Please email us your name, phone number, problem/issue and availability Mon - Fri 9am - 5pm EDT.</p>
           </div>
